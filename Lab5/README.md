...
🎥 [Watch Demo Video](https://youtu.be/d1XCpha_76U)
...
services:
  ...
  order-service:
    ...
    image: "usamaiqbal25/order-service:latest"
  ...
  product-service:
    ...
    image: "usamaiqbal25/product-service:latest"
  ...
  store-front:
    ...
    image: "usamaiqbal25/store-front:latest"
